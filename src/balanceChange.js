...
export async function getBalanceChange(address, token, page = 1, pageSize = 100) {
    ...
    const parseTransaction = (data, priceAndName) => {
        let _data = {
            ...
            "trans_id": "4VYRmT6NEne1JbU5JLAR7PFF2gb9qnPnyfLt4s6N4y2LXUSduS16gyFi6oDsVgywkQQ9pSK4zHngtSzRCwtR6ycC",
